        ...
        <div class="container">
            <div class="section">
                ...
                <div class="row center">
                    <h1 class="blue-grey-text">Museos</h1>
                </div>
                <div class="row">
                    <div class="right-align">
                        <a class="btn-floating btn-large waves-effect waves-light blue-grey " title="Agregar" 
                        href="formMuseo.php" name="opcion" value="lol"><i class="material-icons">add</i></a>
                    </div>
                    <br>
                    <?php
